...
base_model=keras.applications.mobilenet.MobileNet(input_shape=(224, 224, 3), alpha = 0.25,depth_multiplier = 1, dropout = 0.001, pooling='avg',include_top = False, weights = "imagenet", classes = 1000)
x=base_model.output
